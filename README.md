...
| [aws_route.transit_gateway_to_firewall](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_additional_destination_cidr_block"></a> [additional\_destination\_cidr\_block](#input\_additional\_destination\_cidr\_block) | The additional CIDR Block that would be used in our private/public route tables. | `string` | `""` | no |
...
| <a name="input_enable_additional_private_route"></a> [enable\_additional\_private\_route](#input\_enable\_additional\_private\_route) | This needs to be set to true if we want to create additional routes in our private route table. | `bool` | `false` | no |
| <a name="input_enable_additional_public_route"></a> [enable\_additional\_public\_route](#input\_enable\_additional\_public\_route) | This needs to be set to true if we want to create additional routes in our public route table. | `bool` | `false` | no |
...
| <a name="input_enable_transit_gateway_private_route"></a> [enable\_transit\_gateway\_private\_route](#input\_enable\_transit\_gateway\_private\_route) | Indicates whether to create a route to TGW for VPC private subnets | `bool` | `false` | no |
| <a name="input_enable_transit_gateway_to_firewall_route"></a> [enable\_transit\_gateway\_to\_firewall\_route](#input\_enable\_transit\_gateway\_to\_firewall\_route) | Indicates whether to create a route from TGW subnet to network firewall endpoint in the same AZ | `bool` | `false` | no |
...
| <a name="input_network_firewall_endpoints"></a> [network\_firewall\_endpoints](#input\_network\_firewall\_endpoints) | List of Network Firewall endpoint IDs | `list(string)` | <pre>[<br/>  ""<br/>]</pre> | no |
...
| <a name="input_separate_tgw_route_table_per_az"></a> [separate\_tgw\_route\_table\_per\_az](#input\_separate\_tgw\_route\_table\_per\_az) | Flag to indicate whether to create separate route tables per availability zone for transit gateway subnets | `bool` | `false` | no |
| <a name="input_single_nat_gateway"></a> [single\_nat\_gateway](#input\_single\_nat\_gateway) | Should be true if you want to provision a single shared NAT Gateway across all of your private networks | `bool` | `false` | no |
| <a name="input_tags"></a> [tags](#input\_tags) | A map of tags to add to all resources | `map(string)` | `{}` | no |
| <a name="input_tgw_id_private_route"></a> [tgw\_id\_private\_route](#input\_tgw\_id\_private\_route) | ID of the TGW if enable\_transit\_gateway\_private\_route is enabled | `string` | `""` | no |
| <a name="input_transit_gateway_route_table_tags"></a> [transit\_gateway\_route\_table\_tags](#input\_transit\_gateway\_route\_table\_tags) | Additional tags for the transit\_gateway route tables | `map(string)` | `{}` | no |
| <a name="input_transit_gateway_subnet_assign_ipv6_address_on_creation"></a> [transit\_gateway\_subnet\_assign\_ipv6\_address\_on\_creation](#input\_transit\_gateway\_subnet\_assign\_ipv6\_address\_on\_creation) | Specify true to indicate that network interfaces created in the specified subnet should be assigned an IPv6 address. Default is `false` | `bool` | `false` | no |
| <a name="input_transit_gateway_subnet_enable_dns64"></a> [transit\_gateway\_subnet\_enable\_dns64](#input\_transit\_gateway\_subnet\_enable\_dns64) | Indicates whether DNS queries made to the Amazon-provided DNS Resolver in this subnet should return synthetic IPv6 addresses for IPv4-only destinations. Default: `true` | `bool` | `true` | no |
| <a name="input_transit_gateway_subnet_enable_resource_name_dns_a_record_on_launch"></a> [transit\_gateway\_subnet\_enable\_resource\_name\_dns\_a\_record\_on\_launch](#input\_transit\_gateway\_subnet\_enable\_resource\_name\_dns\_a\_record\_on\_launch) | Indicates whether to respond to DNS queries for instance hostnames with DNS A records. Default: `false` | `bool` | `false` | no |
| <a name="input_transit_gateway_subnet_enable_resource_name_dns_aaaa_record_on_launch"></a> [transit\_gateway\_subnet\_enable\_resource\_name\_dns\_aaaa\_record\_on\_launch](#input\_transit\_gateway\_subnet\_enable\_resource\_name\_dns\_aaaa\_record\_on\_launch) | Indicates whether to respond to DNS queries for instance hostnames with DNS AAAA records. Default: `true` | `bool` | `true` | no |
| <a name="input_transit_gateway_subnet_ipv6_native"></a> [transit\_gateway\_subnet\_ipv6\_native](#input\_transit\_gateway\_subnet\_ipv6\_native) | Indicates whether to create an IPv6-only subnet. Default: `false` | `bool` | `false` | no |
| <a name="input_transit_gateway_subnet_ipv6_prefixes"></a> [transit\_gateway\_subnet\_ipv6\_prefixes](#input\_transit\_gateway\_subnet\_ipv6\_prefixes) | Assigns IPv6 transit\_gateway subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list | `list(string)` | `[]` | no |
| <a name="input_transit_gateway_subnet_names"></a> [transit\_gateway\_subnet\_names](#input\_transit\_gateway\_subnet\_names) | Explicit values to use in the Name tag on transit\_gateway subnets. If empty, Name tags are generated | `list(string)` | `[]` | no |
| <a name="input_transit_gateway_subnet_private_dns_hostname_type_on_launch"></a> [transit\_gateway\_subnet\_private\_dns\_hostname\_type\_on\_launch](#input\_transit\_gateway\_subnet\_private\_dns\_hostname\_type\_on\_launch) | The type of hostnames to assign to instances in the subnet at launch. For IPv6-only subnets, an instance DNS name must be based on the instance ID. For dual-stack and IPv4-only subnets, you can specify whether DNS names use the instance IPv4 address or the instance ID. Valid values: `ip-name`, `resource-name` | `string` | `null` | no |
| <a name="input_transit_gateway_subnet_suffix"></a> [transit\_gateway\_subnet\_suffix](#input\_transit\_gateway\_subnet\_suffix) | Suffix to append to transit\_gateway subnets name | `string` | `"transit_gateway"` | no |
| <a name="input_transit_gateway_subnet_tags"></a> [transit\_gateway\_subnet\_tags](#input\_transit\_gateway\_subnet\_tags) | Additional tags for the transit\_gateway subnets | `map(string)` | `{}` | no |
| <a name="input_transit_gateway_subnet_tags_per_az"></a> [transit\_gateway\_subnet\_tags\_per\_az](#input\_transit\_gateway\_subnet\_tags\_per\_az) | Additional tags for the transit\_gateway subnets where the primary key is the AZ | `map(map(string))` | `{}` | no |
| <a name="input_transit_gateway_subnets"></a> [transit\_gateway\_subnets](#input\_transit\_gateway\_subnets) | A list of transit\_gateway subnets inside the VPC | `list(string)` | `[]` | no |
...
| <a name="output_private_subnet_0_arn"></a> [private\_subnet\_0\_arn](#output\_private\_subnet\_0\_arn) | List of ARNs of private subnets |
| <a name="output_private_subnet_1_arn"></a> [private\_subnet\_1\_arn](#output\_private\_subnet\_1\_arn) | List of ARNs of private subnets |
| <a name="output_private_subnet_2_arn"></a> [private\_subnet\_2\_arn](#output\_private\_subnet\_2\_arn) | List of ARNs of private subnets |
...
| <a name="output_transit_gateway_subnets"></a> [transit\_gateway\_subnets](#output\_transit\_gateway\_subnets) | List of IDs of transti gateway subnets |
