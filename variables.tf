...
variable "enable_additional_public_route" {
  description = "This needs to be set to true if we want to create additional routes in our public route table."
  type        = bool
  default     = false
}
...
variable "transit_gateway_subnets" {
  description = "A list of transit_gateway subnets inside the VPC"
  type        = list(string)
  default     = []
}
...
variable "transit_gateway_subnet_enable_dns64" {
  description = "Indicates whether DNS queries made to the Amazon-provided DNS Resolver in this subnet should return synthetic IPv6 addresses for IPv4-only destinations. Default: `true`"
  type        = bool
  default     = true
}

variable "transit_gateway_subnet_enable_resource_name_dns_aaaa_record_on_launch" {
  description = "Indicates whether to respond to DNS queries for instance hostnames with DNS AAAA records. Default: `true`"
  type        = bool
  default     = true
}

variable "transit_gateway_subnet_enable_resource_name_dns_a_record_on_launch" {
  description = "Indicates whether to respond to DNS queries for instance hostnames with DNS A records. Default: `false`"
  type        = bool
  default     = false
}
...
variable "transit_gateway_subnet_ipv6_native" {
  description = "Indicates whether to create an IPv6-only subnet. Default: `false`"
  type        = bool
  default     = false
}

variable "transit_gateway_subnet_private_dns_hostname_type_on_launch" {
  description = "The type of hostnames to assign to instances in the subnet at launch. For IPv6-only subnets, an instance DNS name must be based on the instance ID. For dual-stack and IPv4-only subnets, you can specify whether DNS names use the instance IPv4 address or the instance ID. Valid values: `ip-name`, `resource-name`"
  type        = string
  default     = null
}

variable "transit_gateway_subnet_names" {
  description = "Explicit values to use in the Name tag on transit_gateway subnets. If empty, Name tags are generated"
  type        = list(string)
  default     = []
}

variable "transit_gateway_subnet_suffix" {
  description = "Suffix to append to transit_gateway subnets name"
  type        = string
  default     = "transit_gateway"
}

variable "transit_gateway_subnet_tags" {
  description = "Additional tags for the transit_gateway subnets"
  type        = map(string)
  default     = {}
}

variable "transit_gateway_subnet_tags_per_az" {
  description = "Additional tags for the transit_gateway subnets where the primary key is the AZ"
  type        = map(map(string))
  default     = {}
}

variable "transit_gateway_route_table_tags" {
  description = "Additional tags for the transit_gateway route tables"
  type        = map(string)
  default     = {}
}

variable "separate_tgw_route_table_per_az" {
  description = "Flag to indicate whether to create separate route tables per availability zone for transit gateway subnets"
  type        = bool
  default     = false
}

variable "enable_transit_gateway_private_route" {
  description = "Indicates whether to create a route to TGW for VPC private subnets"
  type        = bool
  default     = false
}

variable "tgw_id_private_route" {
  description = "ID of the TGW if enable_transit_gateway_private_route is enabled"
  type        = string
  default     = ""
}
...
variable "network_firewall_endpoints" {
...
variable "enable_additional_private_route" {
  description = "This needs to be set to true if we want to create additional routes in our private route table."
  type        = bool
  default     = false
}
variable "additional_destination_cidr_block" {
